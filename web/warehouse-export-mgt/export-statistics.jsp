    ...
    <div class="main-content-with-sidebar">
        <div class="card">
            <div class="card-header">
                <div>
                    <h1 class="card-title">Export Statistics</h1>
                    <p class="card-subtitle">Analyze export activity and trends over time</p>
                </div>
            ...
            <div class="card-body">
                ...
                <!-- Filter Form -->
                <form class="filter-bar" method="get" action="${pageContext.request.contextPath}/warehouse-export-mgt/export-statistics">
                    ...
                    <c:if test="${totalPages > 1}">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid var(--gray-200);">
                            ...
                            <div style="display: flex; gap: 0.5rem;">
                                <c:url var="prevUrl" value="${pageContext.request.contextPath}/warehouse-export-mgt/export-statistics">
                                ...
                                <c:url var="nextUrl" value="${pageContext.request.contextPath}/warehouse-export-mgt/export-statistics">
                                    <c:param name="startDate" value="${startDateDisplay}" />
                                    <c:param name="endDate" value="${endDateDisplay}" />
                                    <c:param name="groupBy" value="${groupBy}" />
                                    <c:param name="page" value="${currentPage + 1}" />
                                ...
                                <c:if test="${totalPages > 1}">
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <c:if test="${i == currentPage || (i >= currentPage - 2 && i <= currentPage + 2)}">
                                            <c:url var="pageUrl" value="${pageContext.request.contextPath}/warehouse-export-mgt/export-statistics">
                                                <c:param name="startDate" value="${startDateDisplay}" />
                                                <c:param name="endDate" value="${endDateDisplay}" />
                                                <c:param name="groupBy" value="${groupBy}" />
