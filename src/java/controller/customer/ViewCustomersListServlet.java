...
public class ViewCustomersListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Customer> customers = dao.findAll(offset, size, sortBy, sortDir, search, status);
            ...
            request.getRequestDispatcher("/customer-mgt/customer-list.jsp").forward(request, response);
