package model; // Thay bằng package thực tế
...
public class ImportReceipt {
    ...
    public ImportReceipt(int supplierId, int userId, Date date, int totalQuantity, double totalAmount, String note, Date createdAt) {
